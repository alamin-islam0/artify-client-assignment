          ...
          <div className="flex items-end justify-between mb-6">
            <div>
              ...
              <p className="mt-1 text-sm opacity-70 montserrat-font">
                Fresh uploads and trending categories from the community.
              </p>
            </div>
            <Link
              to="/explore"
          ...
          <div className="space-y-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {loading ? (
                  Array.from({ length: 4 }).map((_, i) => (
                    <span
                      key={i}
                      className="inline-block h-6 w-24 rounded bg-base-200 animate-pulse"
                    />
                  ))
                ) : categories.length ? (
                  categories.map((c) => (
                    <span key={c.name} className="badge badge-outline">
                      {c.name}{" "}
            ...
            <div className="rounded-xl border border-base-300 bg-base-100 p-4">
              ...
              <ul className="mt-2 space-y-2 text-sm opacity-80">
                ...
                <li>
                  Tag your artwork with an appropriate category and medium.
                </li>
              ...
              >
                <div className="rounded-xl border border-base-300 bg-base-100 overflow-hidden flex gap-4 p-3 items-center">
                  ...
                  <div className="min-w-0">
                    <div className="font-semibold inter-font line-clamp-1">
                      {art?.title || (loading ? null : "Untitled")}
                    </div>
